...
import (
	...
	"github.com/dapperlabs/flow-dps/service/cloud"
	"github.com/dapperlabs/flow-dps/service/forest"
	"github.com/dapperlabs/flow-dps/service/index"
	"github.com/dapperlabs/flow-dps/service/initializer"
	"github.com/dapperlabs/flow-dps/service/loader"
	"github.com/dapperlabs/flow-dps/service/mapper"
	"github.com/dapperlabs/flow-dps/service/metrics"
	"github.com/dapperlabs/flow-dps/service/storage"
	"github.com/dapperlabs/flow-dps/service/tracker"
)
...
func run() int {
	...
	follow, err := unstaked.NewConsensusFollower(
		...
		unstaked.WithExposeMetrics(true),
	)
	if err != nil {
